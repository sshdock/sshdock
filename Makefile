...
.PHONY: setup fmt lint test smoke e2e e2e-docker ssh-e2e bootstrap-e2e server-push-e2e route-e2e tui-e2e tui-screenshots-real tui-screenshots-vps recovery-e2e hardening-e2e ci build clean check-tools
