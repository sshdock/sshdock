...
```bash
go test ./test/harness -run 'Test(AdoptionDocs|Examples|PublicExamples|NextJSCompatibilityProbe|NestJSQuickstart|LaravelCompatibilityProbe|ConfigExample|RollbackLab|WordPressExample|ProjectBranding)'
```
