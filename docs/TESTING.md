...
```bash
go test ./test/harness -run 'Test(AdoptionDocs|Examples|PublicExamples|NextJSCompatibilityProbe|NestJSQuickstart|LaravelQuickstart|ConfigExample|RollbackLab|WordPressExample|ProjectBranding)'
```
