	...
	examples := []publicExampleContract{
		...
		},
		{
			...
			requiredFiles: []string{
				...
				"phpunit.xml",
				"vite.config.js",
				filepath.Join("app", "Http", "Controllers", "Controller.php"),
				filepath.Join("app", "Models", "User.php"),
				filepath.Join("app", "Providers", "AppServiceProvider.php"),
				filepath.Join("bootstrap", "app.php"),
				filepath.Join("public", "index.php"),
				filepath.Join("resources", "views", "welcome.blade.php"),
